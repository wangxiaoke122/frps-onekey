...
export github_download_url="https://github.com/wangxiaoke122/frps-onekey/releases/download"
export gitee_latest_version_api="https://gitee.com/api/v5/repos/MvsCode/frps-onekey/releases/latest"
export github_latest_version_api="https://api.github.com/repos/wangxiaoke122/frps-onekey/releases/latest"
#======================================================================
...
str_install_shell="https://raw.githubusercontent.com/wangxiaoke122/frps-onekey/master/install-frps_v0.58.0.sh"
shell_update(){
    fun_clangcn "clear"
